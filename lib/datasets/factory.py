...
for year in ['2007', '2012']:
  for split in ['train', 'val', 'trainval', 'test']:
    ...
    __sets[name] = (lambda split=split, year=year: pascal_voc(split, year, '/home/cvlab/PycharmProjects/SN-faster-rcnn/data/voc/'))

for year in ['2007']:
  for split in ['train_t', 'test_t']:
    name = 'voc_clipart_{}_{}'.format(year, split)
    __sets[name] = (lambda split=split, year=year: pascal_voc(split, year, '/home/cvlab/PycharmProjects/SN-faster-rcnn/data/clipart/'))
...
for year in ['2007']:
  for split in ['trainall', 'train500']:
    ...
    __sets[name] = (lambda split=split, year=year: KITTI(split, year, '/home/cvlab/PycharmProjects/SN-faster-rcnn/data/KITTI/'))
  for year in ['2007']:
      for split in ['train_s', 'test_s', 'train_t','test_t', 'test_s500']:
          name = 'KITTI_cityscape_{}_{}'.format(year, split)
          __sets[name] = (lambda split=split, year=year: KITTI(split, year, '/home/cvlab/PycharmProjects/SN-faster-rcnn/data/cityscape/'))
